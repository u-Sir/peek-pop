...
async function handleDragStart(e) {
    ...
    if (window.self !== window.top && window.origin !== 'https://viewscreen.githubusercontent.com') {
        ...
        window.addEventListener('dragend', (e) => {
            ...
            window.parent.postMessage({ action: 'dragendCheck', top, left, endY, endX, endTimestamp, lastLeaveTimestampFromIframe: lastLeaveTimestamp }, '*');
                ...
                fetch(url, { redirect: 'follow' })
                    .then((response) => {
                        ...
                        return response.text().then((html) => {
                            ...
                            const title = (doc.querySelector("title")?.innerText === "微博搜索") ?
