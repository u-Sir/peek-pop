        ...
        .then(({ popupWindowsInfo, userConfigs }) => {
          ...
          if (!request.linkUrl) {
            ...
            if (request.action === "sendPageBack") {
              ...
              if (
                popupWindowsInfo &&
                Object.keys(popupWindowsInfo).length > 0
              ) {
...
function createPopupWindow(
  ...
  if (trigger === "drag") {
    popupInBackground =
      userConfigs.popupInBackground !== undefined
        ? userConfigs.popupInBackground
        : false;
  } else if (trigger === "hover" || trigger === "tooltips") {
    popupInBackground =
      userConfigs.hoverPopupInBackground !== undefined
        ? userConfigs.hoverPopupInBackground
        : false;
  } else if (trigger === "click") {
    popupInBackground =
      userConfigs.previewModePopupInBackground !== undefined
